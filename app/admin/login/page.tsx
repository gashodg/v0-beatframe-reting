      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-sm border border-border bg-card p-8">
          ...
          >
            <button
              type="submit"
              className="w-full h-11 rounded-sm bg-foreground text-background text-sm font-semibold flex items-center justify-center gap-3 hover:bg-foreground/90 transition-colors"
            >
              <GoogleIcon />
